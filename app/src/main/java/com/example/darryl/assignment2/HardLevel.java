...
public class HardLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1 = MediaPlayer.create(HardLevel.this, R.raw.correct);
        player2 = MediaPlayer.create(HardLevel.this, R.raw.wrong);
        ...
        if (bundle != null) {
            level = bundle.getInt("hard_level");
            txtTitle.setText("Level " + level);

            img.setImageResource(bundle.getInt("hard_imgId"));
            ...
            imgHint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    hint = getString(bundle.getInt("hard_hints"));
            ...
            answer = getString((bundle.getInt("hard_answer")));
            btnCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (txtAnswer.getText().toString().equalsIgnoreCase(answer)) {
                        ...
                        HardLevelSelection.hard_done[level - 1] = 1;
                            ...
                            imgNext.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (level - 1 <= 10) {
                                        ...
                                        if (HardLevelSelection.hard_done[level - 1] == 1) {
                                            level = HardLevelSelection.hard_level[level - 1];
                                            txtTitle.setText("Level " + level);

                                            img.setImageResource(HardLevelSelection.hard_imgId[level - 1]);

                                            correct = getString(HardLevelSelection.hard_answers[level - 1]);
                                            txtHint.setText(correct);
                                            txtHint.setAllCaps(true);
                                            ...
                                            if (level - 1 > 9) {
                                                Intent i = new Intent(HardLevel.this, HardLevelSelection.class);
                                                startActivity(i);
                                            } else {
                                                ...
                                                imgHint.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        hint = getString(HardLevelSelection.hard_hints[level - 1]);
                                                        txtHint.setText(hint);
                                                ...
                                                answer = getString(HardLevelSelection.hard_answers[level - 1]);
                                            }
                                        }
                                    }
                                }
    ...
    public void onBackPressed() {
        ...
        if (MainMenu.mp.isPlaying()) {
            HardLevelSelection.audio.setImageResource(R.drawable.audio);//if user press back while audio is playing,
                                                                        //the image in main menu will be set to unmute
        } else {
            HardLevelSelection.audio.setImageResource(R.drawable.mute);//if user press back while audio is not playing,
    ...
    public void onResume() {
        ...
        if(bundle.getInt("hard_done") == 1) {
            correct = getString(bundle.getInt("hard_answer"));
            txtHint.setText(correct);
            txtHint.setAllCaps(true);
