...
public class EasyLevel extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        player1 = MediaPlayer.create(EasyLevel.this, R.raw.correct);
        player2 = MediaPlayer.create(EasyLevel.this, R.raw.wrong);
        ...
        if (bundle != null) {
            level = bundle.getInt("easy_level");
            txtTitle.setText("Level " + level);

            img.setImageResource(bundle.getInt("easy_imgId"));
            ...
            imgHint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    hint = getString(bundle.getInt("easy_hints"));
            ...
            answer = getString((bundle.getInt("easy_answer")));
            btnCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (txtAnswer.getText().toString().equalsIgnoreCase(answer)) {
                        ...
                        EasyLevelSelection.easy_done[level - 1] = 1;
                            ...
                            imgNext.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (level - 1 <= 10) {
                                        ...
                                        if (EasyLevelSelection.easy_done[level - 1] == 1) {
                                            level = EasyLevelSelection.easy_level[level - 1];
                                            txtTitle.setText("Level " + level);

                                            img.setImageResource(EasyLevelSelection.easy_imgId[level - 1]);

                                            correct = getString(EasyLevelSelection.easy_answers[level - 1]);
                                            txtHint.setText(correct);
                                            txtHint.setAllCaps(true);
                                            ...
                                            if (level - 1 > 9) {
                                                Intent i = new Intent(EasyLevel.this, EasyLevelSelection.class);
                                                startActivity(i);
                                            } else {
                                                ...
                                                imgHint.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        hint = getString(EasyLevelSelection.easy_hints[level - 1]);
                                                        txtHint.setText(hint);
                                                ...
                                                answer = getString(EasyLevelSelection.easy_answers[level - 1]);
                                            }
                                        }
                                    }
                                }
    ...
    public void onBackPressed() {
        ...
        if (MainMenu.mp.isPlaying()) {
            EasyLevelSelection.audio.setImageResource(R.drawable.audio);//if user press back while audio is playing,
                                                                        //the image in main menu will be set to unmute
        } else {
            EasyLevelSelection.audio.setImageResource(R.drawable.mute);//if user press back while audio is not playing,
    ...
    public void onResume() {
        ...
        if(bundle.getInt("easy_done") == 1) {
            correct = getString(bundle.getInt("easy_answer"));
            txtHint.setText(correct);
            txtHint.setAllCaps(true);
